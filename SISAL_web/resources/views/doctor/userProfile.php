                    ...
                    <form>
                        <div class="panel panel-default"aria-multiselectable="true">
                            <div class="panel-heading">
                                ...
                                <span><h2>Médico: < inserte nombre aqui ></h2></span>
                            </div>
                            <div id="tablist">
                                ...
                                <div>
                                    ...
                                    <div class="panel-body collapse indent" id="aPer">
                                        <div class="form-group">
                                            <input class="form-control" type="text" placeholder="Domicilio consulta particular"/>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" type="text" placeholder="Telefono de emergencias"/>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" type="text" placeholder="Celular de emergencias"/>
                                        </div>
                                        <div class="form-group">
                                            <input class="form-control" type="email" placeholder="Correo Electrónico"/>
                                        </div>
