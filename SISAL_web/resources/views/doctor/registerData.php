                                        ...
                                        <div class="form-group">
                                            ...
                                            <table>
                                                <tr>
                                                    ...
                                                    <td colspan="3"><input type="number" name="peso" id="peso"min="000" max="999" pattern="^[0-9][0-9]{1}[0-9]$"  required/></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td  colspan="3"><input type="number" name="talla" id="talla" min="000" max="999" pattern="^[0-9][0-9]{1}[0-9]$" required/></td>
                                                    <td><label>Cm</label></td>
                                                </tr>
                                                <tr>
                                                    <td><label>Frec Respiratoria: </label></td>
                                                    <td  colspan="3"><input type="number" name="frecResp" id="frecResp" min="000" max="999" pattern="^[0-9][0-9]{1}[0-9]$" required/></td>
                                                    <td><label>por minuto</label></td>
                                                </tr>
                                                <tr>
                                                    <td><label>Presion alterial: </label></td>
                                                    <td><input type="number" class="inputLowNumber" name="presBaja" id="presBaja"min="000" max="999" pattern="^[0-9][0-9]{1}[0-9]$" required/></td>
                                                    <td align="center"><label>/</label></td>
                                                    <td><input type="number" class="inputLowNumber" name="presAlta" id="presAlta"min="000" max="999" pattern="^[0-9][0-9]{1}[0-9]$" required/></td>
